...
moduleForComponent('list-filter', 'Integration | Component | lfilter listing', {
  integration: true
});
...
test('should initially load all listing', function(assert) {
  // Set any properties with this.set('myProperty', 'value');
  // Handle any actions with this.on('myAction', function(val) { ... });

  //we want our actions to return promises, since they are potencially fetching data asynchronously
